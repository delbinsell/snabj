  ...
  return (
    <Card noPadding={true}>
      <div className="px-4 py-2 flex justify-between md:block shadow-md shadow-gray-500 md:shadow-none">
        <h2 className="text-gray-400 mb-3 hidden md:block">SNABJ</h2>
        ...
        {userId && (
          <Link href={`/profile/${userId}`} className={pathname.startsWith(`/profile/${userId}`) ? activeElementClasses : nonActiveElementClasses}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        <Link href="/saved" className={pathname === '/saved' ? activeElementClasses : nonActiveElementClasses}>
          ...
          <span className="hidden md:block">Posts guardados </span>
        </Link>
