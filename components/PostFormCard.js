      ...
      <div className="flex gap-2">
        ...
        {profile && (
          <textarea value={content}
                    ...
                    className="grow p-3 h-14" placeholder={`Que estas pensando, ${profile?.name}?`} />
        )}
      </div>
      {isUploading && (
        <div>
      ...
      <div className="flex gap-5 items-center mt-2">
        ...
        <div>
          <button className="flex gap-1">
            ...
            <span className="hidden md:block">Ubicacion</span>
          </button>
        </div>
        <div>
          <button className="flex gap-1">
        ...
        <div className="grow text-right">
          <button onClick={createPost} className="bg-socialBlue text-white px-6 py-1 rounded-md">Publicar</button>
        </div>
      </div>
    </Card>
  );
